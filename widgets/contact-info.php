...
class Sydney_Contact_Info extends WP_Widget {
	...
	<p><label for="<?php echo $this->get_field_id( 'facebook' ); ?>"><?php _e( 'Enter your facebook address', 'sydney' ); ?></label>
	...
	function widget($args, $instance) {
		...
		if( ($facebook) ) {
			echo '<div class="contact-facebook">';
			echo '<span><i class="fa fa-facebook"></i></span>' . '<a href="https://www.facebook.com/escolavoandoalto">https://www.facebook.com/escolavoandoalto</a>';
			echo '</div>';
		}
